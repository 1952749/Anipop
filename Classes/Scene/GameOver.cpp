...
bool GameOver::init()
{
	...
	//PlayGround
	auto PlayBG = Sprite::create("GameOver/PlayBG.png");
	if (PlayBG == nullptr)
	{
		problemLoading("'GameOver/PlayBG.jpg'");
	}
	else
	{
	...
	//显示分数的板块
	auto ScoreBG = Sprite::create("GameOver/ScoBG.png");
	...
	auto playAgainItem = MenuItemImage::create(
		"GameOver/ReplayNormal.png",
		"GameOver/ReplaySelected.png",
	...
	auto returnItem = MenuItemImage::create(
		"GameOver/ReturnNormal.png",
		"GameOver/ReturnSelected.png",
