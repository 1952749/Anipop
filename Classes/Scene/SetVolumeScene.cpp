...
bool SetVolume::init()
{
	...
	auto ReturnItem = MenuItemImage::create(
		"SetVolume/ReturnNormal.png",
		"SetVolume/ReturnSelected.png",
	...
	//音乐
	auto music_bgm = Sprite::create("SetVolume/SetBGM.png");
	music_bgm->setPosition(Vec2(visibleSize.width / 3 + 50, visibleSize.height / 3*2 -50));
	this->addChild(music_bgm, 2);
	
	//音效
	auto effect_bgm = Sprite::create("SetVolume/SetSoundEffect.png");
	...
	music_slider->loadBarTexture("SetVolume/sliderTrack.png");
	music_slider->loadSlidBallTextures("SetVolume/sliderballnormal.png", "SetVolume/sliderballnormal.png", "");
	music_slider->loadProgressBarTexture("SetVolume/sliderProgress.png");
	...
	effect_slider->loadBarTexture("SetVolume/sliderTrack.png");
	effect_slider->loadSlidBallTextures("SetVolume/sliderballnormal.png", "SetVolume/sliderballnormal.png", "");
	effect_slider->loadProgressBarTexture("SetVolume/sliderProgress.png");
